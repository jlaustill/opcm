...
void ISR_trig1()
{
    ...
    else if (dataCB[6] == 0x3E && dataCB[7] == 0x80)
    {                                     // ID: 7DF8 2 3E 80 0 0 0 0 0
...
void CanBus::initialize()
{
    ...
    if (readRegister2(CAN_BUS_CS_PIN, 0x0E) == 0 && readRegister2(CAN_BUS_CS_PIN, 0x0F) == 04)
    { // mode status to check if init happened correctly
